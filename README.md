<p>
  Sou pós-graduado em <span style="font-weight: bold;">Ciência de Dados e Big Data</span> pela Pontifícia Universidade Católica de Minas Gerais, além de tecnólogo em <span style="font-weight: bold;">Sistemas para Internet</span> e pós-graduado em <span style="font-weight: bold;">Desenvolvimento Web/Mobile</span> pelo Instituto Federal de Educação, Ciência e Tecnologia do Sudeste de Minas. Tenho experiência em programação <span style="font-style: italic;">back-end</span> com o framework <span style="font-weight: bold;">Django</span>, bem como em algumas atividades relacionadas a <span style="font-weight: bold;">Aprendizado de Máquina e Ciência de Dados</span>. Atualmente, busco aprimorar meus conhecimentos na área de <span style="font-weight: bold; color: blue;">Inteligência Computacional</span>, com o objetivo de desenvolver sistemas <span style="font-style: italic;">web/mobile</span> integrados a aplicações de <span style="font-weight: bold;">Machine Learning</span>.
</p>
